...
"[project]/node_modules/@supabase/auth-helpers-nextjs/dist/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function createClientComponentClient() {
    let { supabaseUrl = ("TURBOPACK compile-time value", "https://crdfbpybnhscprhpkppd.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNyZGZicHlibmhzY3ByaHBrcHBkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU0MzIzMTAsImV4cCI6MjA3MTAwODMxMH0.w0JlDKLDSmwEvPb7VfjWpLkALTfJu9hxk01ykN9lpqw"), options, cookieOptions, isSingleton = true } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
function createPagesServerClient(context) {
    let { supabaseUrl = ("TURBOPACK compile-time value", "https://crdfbpybnhscprhpkppd.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNyZGZicHlibmhzY3ByaHBrcHBkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU0MzIzMTAsImV4cCI6MjA3MTAwODMxMH0.w0JlDKLDSmwEvPb7VfjWpLkALTfJu9hxk01ykN9lpqw"), options, cookieOptions } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createBrowserSupabaseClient() {
    let { supabaseUrl = ("TURBOPACK compile-time value", "https://crdfbpybnhscprhpkppd.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNyZGZicHlibmhzY3ByaHBrcHBkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU0MzIzMTAsImV4cCI6MjA3MTAwODMxMH0.w0JlDKLDSmwEvPb7VfjWpLkALTfJu9hxk01ykN9lpqw"), options, cookieOptions } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
//# sourceMappingURL=node_modules_%40supabase_7741fce1._.js.map